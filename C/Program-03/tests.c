...
int main(void) {
  ...
  TEST(head->next != NULL && head->next->data == 20 &&
       head->next->next == NULL);
  TEST(list_length(head) == 2);

  // 30 -> 10 -> 20 -> NULL
  list_insert_at_beginning(&head, 30);
  TEST(head != NULL && head->data == 30 && head->next->data == 10 &&
       head->next->next->data == 20 && head->next->next->next == NULL);

  // 10 -> 20 -> NULL
  list_remove_at_beginning(&head);
  TEST(head != NULL && head->data == 10 && head->next->data == 20 &&
       head->next->next == NULL);

  // 10 -> 20 -> 40 -> NULL
  list_insert_at_end(&head, 40);
  TEST(head != NULL && head->data == 10 && head->next->data == 20 &&
       head->next->next->data == 40 && head->next->next->next == NULL);
  ...
  // 30 -> 20 -> 10 -> NULL
  list_reverse(&head);
  TEST(head != NULL && head->data == 30 && head->next->data == 20 &&
       head->next->next->data == 10 && head->next->next->next == NULL);
  ...
  TEST(head != NULL && head->data == 50 && head->next->data == 30 &&
       head->next->next->data == 20 && head->next->next->next->data == 10 &&
       head->next->next->next->next == NULL);

  // 50 -> 30 -> 40 -> 20 -> 10 -> NULL
  list_insert_at_index(&head, 2, 40);
  TEST(head != NULL && head->data == 50 && head->next->data == 30 &&
       head->next->next->data == 40 && head->next->next->next->data == 20 &&
  ...
  TEST(head != NULL && head->data == 50 && head->next->data == 30 &&
       head->next->next->data == 40 && head->next->next->next->data == 20 &&
       head->next->next->next->next->data == 10 &&
       head->next->next->next->next->next->data == 60 &&
  ...
  TEST(init != NULL && init->data == 30 && init->next->data == 20 &&
       head->next->next == NULL);
